...
# распаковка всех элементов из подструктур в структуре
def flatten_w_d(l):
    unbox = []
...
# функция принимает список и возвращает результат сложения суммы чисел и суммы длин строк
def sum_data(data):
    num = 0
    lit = 0
...
# функция принимает список со словарями и возвращает сумму значений словарей
